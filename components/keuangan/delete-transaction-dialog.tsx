...
import { formatCurrencyIDR, TRANSACTION_TYPE_LABELS } from "@/lib/transactions/shared";
...
export function DeleteTransactionDialog({
  ...
  onClose: () => void;
  onDeleted: (transactionIds: string[]) => void;
}) {
          ...
          <div className="flex flex-col gap-4 px-6 py-5">
            <div className="flex items-start gap-3 rounded-2xl border border-destructive/30 bg-destructive/10 p-4">
              ...
              <p className="text-sm text-foreground">
                ...
                <span className="font-semibold">{formatCurrencyIDR(transaction.amount)}</span> akan dihapus
                permanen dan saldo akan disesuaikan otomatis.
                {isTransfer ? " Pasangan transfer di akun tujuan juga ikut terhapus." : ""} Tindakan ini tidak
                bisa dibatalkan.
              </p>
            </div>
